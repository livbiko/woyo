...
// Reuses the pre-existing @livbiko/woyo EAS project (created 2026-07-24,
// com.woyo.app confirmed unique on Play Store, Apple listing already
// registered under ascAppId 6794617379) — originally set up for a single
// combined Woyo app, now the identity for the split-off Passenger app.
const EAS_PROJECT_ID = process.env.WOYO_EAS_PROJECT_ID || '7d1b5578-f81d-4e6a-a8bd-23d61b283bfd';
...
const appName = 'Woyo';
const packageName = 'com.woyo.app';
const scheme = 'woyo';
  ...
  expo: {
    ...
    ios: {
      ...
      infoPlist: {
        ...
        NSCameraUsageDescription: 'Utilisé pour la vérification KYC.',
    ...
    plugins: [
      ...
      [
        'expo-image-picker',
        {
          photosPermission: 'Utilisé pour uploader vos documents.',
          cameraPermission: 'Utilisé pour prendre des photos.',
        },
      ],
    ],
    extra: {
