...
// Register background location task at app startup (must be top-level import)
import '../src/tasks/backgroundLocation';

Sentry.init({
  dsn: process.env.EXPO_PUBLIC_SENTRY_DSN,
  environment: 'driver-production',
...
const PLAY_STORE_URL = 'https://play.google.com/apps/internaltest/TODO_WOYO_DRIVER';
